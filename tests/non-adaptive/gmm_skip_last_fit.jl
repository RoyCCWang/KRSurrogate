...
#@everywhere include("../../src/fit/fit_adaptive.jl")
...
a_array = 0.1 .* ones(Float64, D-1) #[0.7; 0.7] # for each dimension.
...
@time c_array, 𝓧_array, θ_array = fitskiplastnonadaptive(f_X_array, X_array,
